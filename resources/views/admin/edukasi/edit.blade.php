...
<div class="card" style="max-width:900px;">
    ...
    <form action="{{ route('admin.edukasi.update', $edukasi) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug', $edukasi->slug) }}" placeholder="contoh: dasar-bantuan-hidup">
        ...
        <div class="form-group">
            ...
            <input type="url" name="url_video" id="url_video" class="form-control" value="{{ old('url_video', $edukasi->url_video) }}">
        ...
        <div class="form-group">
            ...
            <input type="number" name="durasi_menit" class="form-control" value="{{ old('durasi_menit', $edukasi->durasi_menit) }}" placeholder="30" min="1">
        ...
        <div class="form-group">
            <label style="display:flex; align-items:center; gap:8px; cursor:pointer;">
                ...
                <input type="checkbox" name="sertifikat_tersedia" value="1" {{ old('sertifikat_tersedia', $edukasi->sertifikat_tersedia) ? 'checked' : '' }} style="width:18px; height:18px; accent-color:var(--brand-600);">
