                ...
                <div class="pl-penduduk">
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input type="number" name="jumlah_penduduk_l" id="jumlah_penduduk_l"
                            ...
                            value="{{ old('jumlah_penduduk_l', $lansia->jumlah_penduduk_l) }}" min="0" required readonly style="background-color: #f3f4f6; cursor: not-allowed; opacity: 0.8;">
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input type="number" name="jumlah_penduduk_p" id="jumlah_penduduk_p"
                            ...
                            value="{{ old('jumlah_penduduk_p', $lansia->jumlah_penduduk_p) }}" min="0" required readonly style="background-color: #f3f4f6; cursor: not-allowed; opacity: 0.8;">
