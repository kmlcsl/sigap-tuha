...
@section('content')
<div class="page-header"><h1 class="page-header__title">Edit Program</h1></div>
<div class="card" style="max-width:700px;">
    <div class="card__header"><h3 class="card__title"><i class="fas fa-pen"></i> Form Edit Program</h3></div>
